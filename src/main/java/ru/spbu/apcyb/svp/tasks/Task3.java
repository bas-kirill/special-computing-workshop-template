...
public class Task3 {
    protected void printFiles(File curRoot, FileWriter fileWriter) throws IOException {
        for (File curFile : Objects.requireNonNull(curRoot.listFiles())) {
    ...
    /**
     * Программа выводит содержимое директории в отдельный файл.
     *
     * @param args - путь до директории, содержимое которой необходимо вывести и путь до файла,
     * в который осуществляется вывод.
